...
import { PlayCircle, BookOpen, Layers, ChevronLeft, ChevronRight } from 'lucide-react';
        ...
        <div className="space-y-6">
            {loadingCourseId && (
                <MultiStepLoader 
                    loading={true} 
                    loadingStates={[
                        { text: "Fetching course materials..." },
                        { text: "Loading interactive player..." },
                        { text: "Loading AI voiceovers..." }
                    ]} 
                />
            )}
                    ...
                    <div key={course.courseId} className="group relative">
                        ...
                        >
                            ...
                            {loadingCourseId === course.courseId ? (
                                <div className="absolute inset-0 bg-black/60 backdrop-blur-sm z-20 rounded-[2rem]" />
                            ) : (
